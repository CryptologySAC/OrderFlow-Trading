...
const SYMBOL_CFG =
    ...
    (cfg.symbols as Record<string, any>)[cfg.symbol];
...
export class Config {
    ...
    static readonly WINDOW_MS = Number(
        SYMBOL_CFG?.windowMs ?? 90000
    );

    // Server configuration
    static readonly HTTP_PORT = Number(process.env.PORT ?? cfg.httpPort ?? 3000);
    ...
    static readonly DATASTREAM: DataStreamConfig = {
        ...
        reconnectOnHealthFailure: DATASTREAM_CFG.reconnectOnHealthFailure ?? true,
    };
