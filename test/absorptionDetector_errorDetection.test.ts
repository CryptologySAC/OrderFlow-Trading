    ...
    describe("🐛 BUG #1: Wrong EWMA Side Selection", () => {
        describe("CORRECT Logic: Buy Absorption Should Measure Sell Aggression", () => {
            it("should measure SELL aggression when testing BUY-side absorption", () => {
                console.log("🔍 Testing CORRECT EWMA side selection for buy absorption");
                ...
                const buyAbsorptionConditions = detectorAny.checkAbsorptionConditions(
                    testPrice,
                ...
                console.log(`📊 EWMA Values - Buy: ${buyEWMA}, Sell: ${sellEWMA}`);
        ...
        describe("CORRECT Logic: Sell Absorption Should Measure Buy Aggression", () => {
            it("should measure BUY aggression when testing SELL-side absorption", () => {
                console.log("🔍 Testing CORRECT EWMA side selection for sell absorption");
                ...
                // Test the internal absorption condition logic
                const sellAbsorptionConditions = detectorAny.checkAbsorptionConditions(
                    testPrice,
    ...
    describe("🐛 BUG #2: Wrong Volume Aggregation", () => {
        describe("CORRECT Logic: Single-Side Passive Volume in Ratios", () => {
            it("should use ONLY bid volume for buy-side absorption ratios", () => {
                console.log("🔍 Testing CORRECT volume aggregation for buy absorption");
                ...
                if (zoneHistory && zoneHistory.count() > 0) {
                    ...
                    console.log(`📊 Volume Levels - Bid: ${lastSnapshot.bid}, Ask: ${lastSnapshot.ask}`);
                    ...
                    const wrongRatio = aggressiveVolume / (bidVolume + askVolume); // 300/700 = 0.43
                    
                    console.log(`📊 Correct ratio: ${correctRatio}, Wrong ratio: ${wrongRatio}`);
            ...
            it("should use ONLY ask volume for sell-side absorption ratios", () => {
                console.log("🔍 Testing CORRECT volume aggregation for sell absorption");
                ...
                if (zoneHistory && zoneHistory.count() > 0) {
                    ...
                    const wrongRatio = aggressiveVolume / (bidVolume + askVolume); // 240/900 = 0.27
    ...
    describe("🐛 BUG #3: Incomplete Condition Builder", () => {
        describe("CORRECT Logic: All Conditions Calculated from Real Data", () => {
            it("should calculate consistency from actual trade patterns, not use hardcoded default", () => {
                console.log("🔍 Testing CORRECT condition calculation vs hardcoded defaults");
                ...
                const conditions = detectorAny.analyzeAbsorptionConditions?.(testPrice, "buy", detectorAny.calculateZone(testPrice));
                ...
                if (conditions) {
                    ...
                    console.log("✅ Condition calculation validation completed");
                } else {
                    // If analyzeAbsorptionConditions is not implemented properly
                    console.log("⚠️ analyzeAbsorptionConditions method not found or returns undefined");
    ...
    describe("🎯 Integration Test: All Bugs Combined", () => {
        describe("CORRECT Logic: Complete Absorption Detection Pipeline", () => {
            it("should detect all three bugs in the absorption detection pipeline", () => {
                console.log("🔍 Testing complete absorption detection pipeline for errors");
                ...
                console.log("🎯 If any validations fail, detector bugs are present");
            });
        });
    });
});