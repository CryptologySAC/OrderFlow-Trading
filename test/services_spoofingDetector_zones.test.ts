...
describe("services/SpoofingDetector - Zone Functionality", () => {
    ...
    describe("Zone Emission for Spoofing Events", () => {
        it("should emit zone events for fake wall spoofing", () => {
            ...
            const result = detector.wasSpoofed(price, "sell", now + 200, getAggressiveVolume);
        ...
        it("should emit zone events for ghost liquidity", () => {
            ...
            const result = detector.wasSpoofed(price, "buy", now + 200, getAggressiveVolume);
        ...
        it("should emit zone events for layering attacks", () => {
            ...
            const result = detector.wasSpoofed(basePrice, "buy", now + 200, getAggressiveVolume);
    ...
    describe("Zone Properties Validation", () => {
        it("should create zones with correct price ranges", () => {
            ...
            const zoneCall = mockEmit.mock.calls.find(call => call[0] === "zoneUpdated");
            if (zoneCall) {
                ...
                expect(zone.priceRange.max).toBeGreaterThan(zone.priceRange.min);
            }
        });
