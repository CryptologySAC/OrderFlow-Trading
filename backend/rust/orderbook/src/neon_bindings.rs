...
pub fn create_order_book(mut cx: FunctionContext) -> JsResult<JsString> {
...
pub fn update_depth(mut cx: FunctionContext) -> JsResult<JsUndefined> {
    let id = cx.argument::<JsString>(0)?.value(&mut cx);
...
/// Get price level
pub fn get_level(mut cx: FunctionContext) -> JsResult<JsValue> {
    let id = cx.argument::<JsString>(0)?.value(&mut cx);
...
/// Get best bid
pub fn get_best_bid(mut cx: FunctionContext) -> JsResult<JsNumber> {
    let id = cx.argument::<JsString>(0)?.value(&mut cx);
...
/// Get best ask
pub fn get_best_ask(mut cx: FunctionContext) -> JsResult<JsNumber> {
    let id = cx.argument::<JsString>(0)?.value(&mut cx);
...
/// Get spread
pub fn get_spread(mut cx: FunctionContext) -> JsResult<JsNumber> {
    let id = cx.argument::<JsString>(0)?.value(&mut cx);
...
/// Get mid price
pub fn get_mid_price(mut cx: FunctionContext) -> JsResult<JsNumber> {
    let id = cx.argument::<JsString>(0)?.value(&mut cx);
...
/// Sum band
pub fn sum_band(mut cx: FunctionContext) -> JsResult<JsValue> {
    let id = cx.argument::<JsString>(0)?.value(&mut cx);
...
/// Get depth metrics
pub fn get_depth_metrics(mut cx: FunctionContext) -> JsResult<JsValue> {
    let id = cx.argument::<JsString>(0)?.value(&mut cx);
...
/// Clear order book
pub fn clear_order_book(mut cx: FunctionContext) -> JsResult<JsUndefined> {
    let id = cx.argument::<JsString>(0)?.value(&mut cx);
...
/// Get order book size
pub fn get_size(mut cx: FunctionContext) -> JsResult<JsNumber> {
    let id = cx.argument::<JsString>(0)?.value(&mut cx);
...
/// Get health status
pub fn get_health(mut cx: FunctionContext) -> JsResult<JsValue> {
    let id = cx.argument::<JsString>(0)?.value(&mut cx);
