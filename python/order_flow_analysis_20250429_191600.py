# Version 1.3: Dynamic Stop-Loss with Trailing Stop (20250430_000000)
# Changes from Version 1.3 (20250429_173000):
# - Updated VERSION to 20250429_191600
# - Changed transaction_fee to 0.001 (0.1% per trade) from 0.00075 (0.075%)
...
VERSION = "20250429_191600"  # Dynamic Stop-Loss with Trailing Stop, April 29, 2025, 19:16:00
...
def evaluate_parameters(params, df=df):
    ...
    for timeframe in ['Daytime', 'Nighttime']:
        ...
        # Compute returns based on actual entry and exit prices, applying fees
        returns = np.where(
            tf_signals['type'] == 'sell_absorption',  # Long positions
            (tf_signals['exit_price'] / tf_signals['entry_price']) - 1 - 2 * transaction_fee,
            (tf_signals['entry_price'] / tf_signals['exit_price']) - 1 - 2 * transaction_fee  # Short positions
        )
