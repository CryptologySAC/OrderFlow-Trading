...
VOLUME_RATIO_THRESHOLD = 0.5  # Adjusted to 0.5
CUMULATIVE_DELTA_THRESHOLD = -2000  # Adjusted to -2000 USDT
NUM_PROCESSES = 8
...
# Compute static 25th percentile of average SELL LT quantities across all SHPs
...
if __name__ == '__main__':
    ...
    # Compute the static 25th percentile SELL LT quantity threshold
    sell_quantity_threshold = compute_static_sell_quantity_threshold(shp_df, trades, quantity_threshold)
    print(f"Static 25th Percentile SELL LT Quantity Threshold: {sell_quantity_threshold}")
    ...
    # Save to CSV
    results_df.to_csv('shp_refined_pattern_analysis_rolling_parallel_final.csv', index=False)
    print("Analysis saved to 'shp_refined_pattern_analysis_rolling_parallel_final.csv'.")
