...
END_DATE = "2025-05-01"
THRESHOLD = 0.01  # 1% threshold for confirming swings and forming pairs
...
def main():
    ...
    # Save to CSV
    pairs_df.to_csv("swing_high_low_pairs_v10.0.csv", index=False)
    print("Results saved to 'swing_high_low_pairs_v10.0.csv'.")
    ...
    plt.grid(True)
    plt.savefig("swing_pairs_distribution_v10.0.png")
    plt.close()
    print("Distribution plot saved to 'swing_pairs_distribution_v10.0.png'.")
