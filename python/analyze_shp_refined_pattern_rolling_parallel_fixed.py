...
if __name__ == '__main__':
    ...
    # Save to CSV
    results_df.to_csv('shp_refined_pattern_analysis_rolling_parallel.csv', index=False)
    print("Analysis saved to 'shp_refined_pattern_analysis_rolling_parallel.csv'.")
