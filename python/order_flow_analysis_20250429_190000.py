# Version 1.5.2: Fixed Transaction Fee Definition and Updated Fee to 0.1% (20250429_190002)
# Changes from Version 1.5.1 (20250429_190001):
# - Updated VERSION to 20250429_190002
# - Fixed transaction_fee definition in SMA crossover baseline
# - Updated transaction fee to 0.1% per trade (no BNB discount)
# Changes from Version 1.5 (20250429_190000):
...
# - Added confirmThreshold to grid search ([0.0025, 0.0035])
...
VERSION = "20250429_190002"  # Fixed Transaction Fee, April 29, 2025, 19:00:02
...
class OrderFlowAnalyzer:
    def __init__(self, absorptionWindow=5, priceRange=0.005, minLargeOrder=50, volumeWindow=15*60*1000, 
        ...
        self.minLargeOrderCount = 5  # Minimum number of large orders for signal
    ...
    def get_dynamic_trailing_stop(self):
        ...
        scale_factor = min(1.5, max(0.5, avg_quantity / self.minLargeOrder))
...
trailingStopPcts = [0.003, 0.006, 0.009]
absorptionWindows = [5]
priceRanges = [0.005]
minLargeOrders = [50]
volumeWindows = [15*60*1000]
confirmThresholds = [0.0025, 0.0035]
takeProfits = [0.015]
