...
```json
{
  ...
  "affectedPriceRange": { "min": 81.20, "max": 81.28 },
...
* **Recommended action** (continue, reduce\_size, close\_positions, pause)
...
*“Anomaly detection is the first defense against market risk and manipulation—tune, log, and review to maintain edge.”*
