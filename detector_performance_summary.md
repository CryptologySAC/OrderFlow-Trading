...
```json
{
  "baseConfidenceRequired": 1.200,
  "finalConfidenceRequired": 1.320,
...
*Analysis generated using confidence-based synthetic metrics due to missing movement outcome data. Recommend implementing real-time movement tracking for validation of projected improvements.*